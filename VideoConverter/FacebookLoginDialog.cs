...
namespace fb_csharp_sdk_winforms
{
    ...
    public partial class FacebookLoginDialog : Form
    {
        ...
        public FacebookLoginDialog(FacebookClient fb, string appId, string extendedPermissions)
        {
            ...
            //_loginUrl = GenerateLogoutUrl(appId, extendedPermissions);

            InitializeComponent();
        }

        private Uri GenerateLogoutUrl(string appId, string extendedPermissions)
        {
            dynamic parameters = new ExpandoObject();
            parameters.client_id = appId;
            parameters.redirect_uri = GenerateLoginUrl(appId, extendedPermissions);
